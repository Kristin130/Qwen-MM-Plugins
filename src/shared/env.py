...
CONFIG_FIELDS: list[tuple[str, bool, str, str, str]] = [
    ...
    (
        "QWEN_MM_PROVIDER1_BASE_URL",
        False,
        "Credentials & endpoints",
        "",
        "provider 1 (primary) base URL — any OpenAI-compatible endpoint",
    ),
    (
        ...
        "Credentials & endpoints",
        "",
        "provider 1 (primary) API key",
    ),
    (
        "QWEN_MM_PROVIDER1_MODEL",
        False,
        "Credentials & endpoints",
        "",
        "provider 1 model (default: tool default qwen)",
    ),
