...
Capability-specific mapping (e.g. the vision tools' local-path → OSS-object resolution) stays in
that capability; only the pieces every server needs live here.
"""
